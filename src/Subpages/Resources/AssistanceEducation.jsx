        ...
        <>
            <Container className={classes.regularContainer} maxWidth="md">
                ...
                <Typography className={classes.contentTextStyle} variant="body1">
                    Conviction history should not affect educational opportunities after jail or prison, yet many
                    college and universities will collect background information and have full discretion over the
                    admissions process.
                </Typography>
                <Typography className={classes.contentTextStyle} variant="body1">
                    Writing a letter of explanation, gathering refrences, and providing any further aditional
                    information may help in the application process.
                </Typography>
                <Typography className={classes.contentTextStyle} variant="body1">
                    You should never lie on you application. It could result in voiding your application or expulsion if
                    admitted prior to the school finding out.
                </Typography>
            </Container>
                    ...
                    <ListItemMobileSnap
                        ...
                        text={
                            <div>
                                ...
                                <Typography>
                                    For the most part, restrictions on recieving financial aid are removed once
                                    released. As long as the conditions of your sentence are being met, you will most
                                    likey be able to benefit from federal student aid, as well as a few grants and
                                    scholarships.
                                </Typography>
                            </div>
                        }
            ...
            <Container className={classes.regularContainer} maxWidth="md">
                ...
                <Typography className={classes.contentTextStyle} variant="body1">
                    The U.S. Department of Education's office of Federal Student Aid provides more than $120 billion in
                    financial aid to help pay for college or career school each year. Below are ones that apply to the
                    former incarcerated.
                    <br />
                    <br />
