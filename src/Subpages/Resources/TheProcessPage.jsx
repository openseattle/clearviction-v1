                        ...
                        text={
                            <div>
                                ...
                                <Typography>
                                    ...
                                    determine if your conviction can be vacated.
                                </Typography>
                            </div>
                        }
                    />
                    ...
                    <ListItemMobileSnap
                        ...
                        text={
                            <div>
                                ...
                                <Typography>
                                    Next, submit a request to have your conviction vacated (refer to court directory).
                                    Please note that the request to vacate is up to the discretion of the judge and may
                                    be denied for a variety of reasons, including if:
                                </Typography>
                                <Typography className={classes.listItemsStyle} component="ol" variant="body1">
                                    <li>
                                        The court does not believe that vacating your conviction will be in the interest
                                        of society
                                    </li>
                                    <li>You violated probation or have not paid off your fines</li>
                                    <li>You are otherwise not eligible to vacate that conviction</li>
                                    <li>Inaccuracy in your court records and/or the application</li>
                                </Typography>
                            </div>
                        }
                    />
