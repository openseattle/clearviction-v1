...
const LFODetails = (
    <Box>
        ...
        <Box padding={3}>
            <BulletedListMui>
                <li>
                    <ExternalLink href="https://nwjustice.org/clear-hotline">CLEAR hotline</ExternalLink> - refer you to
                    legal organizations
                </li>
                <li>
                ...
                <li>Contact us at contact@clearviction.org and we will get back to you within 24 hours</li>
            </BulletedListMui>
        </Box>
...
const CourtFeesDetails = (
    <div>
        <Typography component="ol">
            <li>
                Ask the Court Clerk which court will hear your motion and which fees will have to be paid. Even if there
                is no hearing, there might be an Ex Parte fee for an agreed order (refer to{" "}
            ...
            <li>
                If the Clerk believes a fee applies, ask them to check with their supervisor and/or the court's
                accounting department.
            </li>
        </Typography>
        <Box paddingTop={3} />
        <Typography>
            If you do not have the financial ability to pay the fees, you might be eligible for relief:
        </Typography>
        <Box padding={3}>
            <BulletedListMui>
                <li>
                    ...
                    to find out if you are eligible to waive your fees (p. 1-2). It also includes the instructions to
                    ask for a fee waiver (p. 4-9) and all necessary forms (p. 10-14). If you have trouble filling out
                    the documents, use this website created by Northwest Justice{" "}
                ...
                <li>You can also contact us at contact@cvp.com because we might be able to assist you.</li>
            </BulletedListMui>
        </Box>
    </div>
);
...
const legalHotlineDetails = (
    <div>
        <Typography variant="body1">
            ...
            <ExternalLink href="https://nwjustice.org/clear-hotline">CLEAR</ExternalLink>, a toll-free legal hotline:
        </Typography>
        <Box padding={3}>
            <BulletedListMui>
        ...
        <Typography>Listed below are attorneys and clinics you can contact directly.</Typography>
    </div>
);
...
const juvenilesDetails = (
    <List>
        <ListItem>
            <ExternalLink href="https://teamchild.org/record-sealing/">TeamChild (Statewide - 4 offices)</ExternalLink>
        </ListItem>
        <ListItem>
            <ExternalLink href="https://ccyj.org/our-work/empowering-foster-homeless-youth/">
                Center for Children & Youth Justice (CCYJ) (Brenton, Franklin, King & Walla Walla County)
            </ExternalLink>
        </ListItem>
    </List>
);
...
const scheduleHearingTabPanelGroup = [
    {
        index: 0,
        label: "Financial Aid",
        content: <AccordionBuilder sectionHeading={"LFOs & Court Fees"} faqs={financialAidFAQ} />,
    },
    {
        index: 1,
        label: "Legal Aid",
        content: <AccordionBuilder sectionHeading={"For low-income applicants:"} faqs={legalAidFAQ} />,
    },
];
