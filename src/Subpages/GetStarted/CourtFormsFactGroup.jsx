...
const courtFormsFacts = [
  {
    ...
    content: (
      <Typography variant="caption">
        ...
        with details about the eligibility to vacate (p. 2-4) and the needed
        court forms (p. 5-13).
      </Typography>
    ),
  },
  {
    ...
    content: (
      <Typography variant="caption">
        ...
        with the steps to vacate (p. 2-6), all necessary court documents (p.
        8-13) and a sample letter for WSP to seal your record (p. 7).
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <Typography variant="caption">
        ...
        including an overview of the eligibility to vacate (p. 3-5), steps to
        vacate (p. 7-12), all necessary court documents (p. 13-23) and a sample
        letter to WSP (p.24).
        <br/>
        <br/>
         To vacate a felony conviction, you will also need
        a Certificate of Discharge. If the court has not issued the Certificate
        of Discharge yet, you must file for a certificate before you can vacate
        the felony. {certificateOfDischargeForm("This packet")} will assist you
        to obtain a Certificate of Discharge in Washington State.
      </Typography>
    ),
  },
  {
    ...
    content: (
      <Typography variant="caption">
        ...
        including an overview of the eligibility to vacate (p.1-2), steps to
        take (p. 3-7), all court forms (p. 8-16), and a sample letter for WSP
        (p. 17).
      </Typography>
    ),
  },
