    ...
    const questions = [
            ...
            details: (
                <>
                    <Typography className={classes.contentTextStyle}>
                        Vacating a conviction is the process of clearing a conviction from your
                        record so it is not visible to the public anymore. Vacating your conviction
                        can remove that crime from some background checks, and you can say legally
                        that you were never convicted of that crime.
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
                        The courts can still reference a vacated conviction in a future criminal
                        proceeding, and not all convictions are eligible for vacation.
                    </Typography>
                </>
            ),
        ...
        },
        {
            ...
            details: (
                <>
                    <Typography className={classes.contentTextStyle}>
                        If you are convicted of a crime, your criminal record will continue to show
                        that conviction in background checks. Having a criminal record might
                        negatively affect your housing, employment, and educational opportunities.
                    </Typography>

                    <Typography className={classes.contentTextStyle}>
                        If you are experiencing this, vacating your conviction removes that crime
                        from background checks, and you can say legally that you were never
                        convicted of that crime. This can help you get access to housing, education,
                        employment, volunteering opportunities, and more.
                    </Typography>
                </>
            ),
        ...
        },
        {
            ...
            details: (
                <>
                    <Typography className={classes.contentTextStyle}>
                        To be eligible to vacate, there are specific criteria that your conviction
                        must meet.
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
                        For misdemeanors, you can use our eligibility calculator to know if you are
                        eligible.
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
        ...
        },
        {
            ...
            details: (
                <>
                    ...
                    <Typography className={classes.contentTextStyle}>
                        (1) the court does not believe that vacating your conviction will be in the
                        interest of society,
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
        ...
        },
        {
            ...
            details: (
                <Typography className={classes.contentTextStyle}>
                    You will receive a court order vacating the conviction—which has the effect of
                    withdrawing the guilty judgment and dismissing the charges against you. You can
                    then legally state that you were not convicted of the offense.
                </Typography>
            ),
            ...
            details: (
                <>
                    ...
                    <Typography className={classes.contentTextStyle}>
                        ...
                        indexes to court records. If a conviction was a domestic violence case,
                        these records and indexes will still show the case type.
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
                    ...
                    <Typography className={classes.contentTextStyle}>
                        ...
                        criminal prosecution. They can still use them in a sexually violent predator
                        commitment proceeding.
                    </Typography>
                    <Typography className={classes.contentTextStyle}>
                        FBI records and private background check records may still have information
