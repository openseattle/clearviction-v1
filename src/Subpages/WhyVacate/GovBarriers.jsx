            ...
            <ListItemMobileSnap
                ...
                text={
                    <Typography className={classes.rootsBodyText} variant="body1">
                        If you are a Washington state resident who is responsible 
                        for the care of a child or are pregnant, you may qualify 
                        for TANF. You cannot receive TANF if you are convicted of 
                        a felony or if you have violated your probation or parole. 
                    </Typography>
                }
            />
            <ListItemMobileSnap
                ...
                text={
                    <Typography className={classes.rootsBodyText} variant="body1">
                        SNAP helps low income people by providing Electronic 
                        Benefits Card (EBT Card) to buy food on a monthly basis. 
                        You cannot receive Basic Food if you are convicted of a 
                        felony or if  have violated your probation or parole.
                    </Typography>
                }
                textLeft
            />
