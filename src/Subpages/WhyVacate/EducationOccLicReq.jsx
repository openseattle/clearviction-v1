                    ...
                    <Grid item xs={12} sm={6} md={6}>
                        <List>
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Amount of time that has elapsed since the last criminal activity"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Work activity of the applicant before and after the criminal conviction"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                            ...
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Extent to which a license might offer an opportunity to engage in further criminal activity"
                            />
                        </List>
                    </Grid>
                    <Grid item xs={12} sm={6} md={6}>
                        <List>
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Evidence of the person’s rehabilitation while incarcerated or after release"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Relationship of a crime to the ability, capacity, or fitness to perform the duties"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Extent and nature of the applicant’s past criminal activity"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Relationship of the crime to the purposes for requiring a license"
                            />
                            <CVPListItem
                                useBulletPoint
                                textAlignment="left"
                                text="Other evidence of the person’s fitness from people with knowledge of the applicant"
                            />
                        </List>
                    </Grid>
                </Grid>
