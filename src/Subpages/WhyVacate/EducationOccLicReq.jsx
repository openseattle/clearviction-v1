                    ...
                    <Grid className={classes.containerSpaceOnlyStyles} container>
                        <Grid item xs={12}>
                            <Typography className={classes.blackHeaderText} variant="h4" align="left">
                                Occupational licensing requirements can be among the most difficult barriers faced by
                                people with criminal records seeking to enter the workforce.
                            </Typography>
                            <Typography
                            ...
                            >
                                The following factors will be considered in determining whether a criminal conviction
                                should be grounds to deny a license:
                            </Typography>
                        </Grid>
