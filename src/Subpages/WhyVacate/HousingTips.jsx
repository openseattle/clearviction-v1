        ...
        >
          <Box>
            ...
            <Grid item sm={12} md={12}>
              <List>
                <IconWithHeaderAndText
                  ...
                  text={["Get as many positive recommendations as you can from anyone who will vouch for you. This includes your family, former employers, or even your rehab facility."]}
                />
                <IconWithHeaderAndText
                  icon={MonetizationOnOutlined}
                  header={"Offer a higher security deposit"}
                  text={["This will let your landlord know that you are willing to go above and beyond to receive, and hold on to, a second chance."]}
                />
                <IconWithHeaderAndText
                  icon={MoveToInboxOutlined}
                  header={"Provide bank statements and pay stubs"}
                  text={["To show that you have the money to pay for both your rent and higher security deposit, you’ll want to provide bank statements showing a steady balance."]}
                />
                <IconWithHeaderAndText
                  icon={NoSimOutlined}
                  header={"Don’t apply for a loan before renting"}
                  text={["Landlords are going to be looking closely at your debt to income ratio. To calculate this, they will add up the cost of rent, along with any other debts you have found during a credit check. Once this number is calculated, it is divided by your annual gross income. Landlords are looking for a DTI of 35 percent or lower."]}
                />
                <IconWithHeaderAndText
                  icon={BorderColorOutlined}
                  header={"Write a personal letter"}
                  text={["Write a letter from the heart, showing your remorse and explaining what kind of person you are today. It could go a long way towards having your application accepted by creating a connection with your landlord and offering a new perspective."]}
                />
                <IconWithHeaderAndText
            ...
            <Typography className={classes.contentText}>
              If you live in Seattle, you have more protection: under a new law, landlords may not require that you talk about your criminal history at all, and may not reject your application for housing because of your adult criminal history unless they think there is a reason to believe you will be a danger to other tenants or to the property
            </Typography>
          </Box>
        </Container>
      </Box>
