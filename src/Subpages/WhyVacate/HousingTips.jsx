      ...
      >
        <Box>
          ...
          <Grid item sm={12} md={12}>
            <List>
              ...
              <IconWithHeaderAndText
                ...
                header={
                  "Provide the “University of Minnesota Study” (if applicable)"
                }
                text={[
          ...
          <Typography className={classes.contentText}>
            If you live in Seattle, you have more protection: under a new law,
            landlords may not require that you talk about your criminal history
            at all, and may not reject your application for housing because of
            your adult criminal history unless they think there is a reason to
            believe you will be a danger to other tenants or to the property
          </Typography>
        </Box>
      </Container>
    </Box>
