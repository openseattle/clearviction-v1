    ...
    return (
        <div className={classes.root}>
            ...
            <Accordion expanded={expanded === "5"} onChange={handleChange("5")}>
                ...
                >
                    <Typography className={classes.heading}>
                        Add a task to someone else's kanban
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <div>
            ...
            <Accordion expanded={expanded === "6"} onChange={handleChange("6")}>
                ...
                >
                    <Typography className={classes.heading}>
                        Track task requests you make of others
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <div>
            ...
            <Accordion expanded={expanded === "7"} onChange={handleChange("7")}>
                ...
                >
                    <Typography className={classes.heading}>
                        Add tasks you created to your view
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <div>
            ...
            <Accordion expanded={expanded === "9"} onChange={handleChange("9")}>
                ...
                >
                    <Typography className={classes.heading}>
                        Create your own tasks for yourself
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <div>
