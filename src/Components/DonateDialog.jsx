...
const DonateDialog = ({ onClose, open }) => {
  ...
  return (
    <>
      ...
      >
        <DialogTitle>
          Right now, we accept donations through Venmo*.
        </DialogTitle>
        <DialogContent>
          <Grid container>
            <Grid item xs={12} sm={6}>
              <img
                src={venmo}
                alt="donate to clearviction qr code"
                width={300}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              ...
              <List>
                ...
                <ListItem>
                  or by scanning this QR code in the Venmo app
                </ListItem>
              </List>
        ...
        <DialogActions>
          <Button  aria-controls="closes dialog" className={classes.closeButtonStyle} onClick={onClose} >okay</Button>
        </DialogActions>
      </Dialog>
    </>
  );
