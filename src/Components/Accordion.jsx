            ...
            {(content).map(({ header, body1, body2, body3, body4, body5 }, idx) => (
                <Accordion key={idx}>
                  ...
                  <AccordionDetails>
                    ...
                    {body3 && (<Text fontFamily={"Lora"} variant={"h5"} text={body3}></Text>) }
                    {body4 && (<Text fontFamily={"Lora"} variant={"h5"} text={body4}></Text>) }
                    {body5 && (<Text fontFamily={"Lora"} variant={"h5"} text={body5}></Text>) }
                  </AccordionDetails>
                </Accordion>
            ))}
          </Container>
