        ...
        <>
                ...
                <Grid container>
                    <Grid item xs={12} sm={12} md={6}>
                        <Typography
                            ...
                            component="p"
                        >
                            Vacate your conviction in the state of Washington by following these 4
                            steps!
                        </Typography>
                        <Box marginTop="8em" marginBottom="8em">
                            <RedesignButtonPrimary
                                href="#read-more"
                                aria-label="to Step 1: Documents"
                            >
                                read more
                            </RedesignButtonPrimary>
                        </Box>
            ...
            >
                ...
                <Typography className={classes.volunteerTextStyle} variant="body1">
                    Gathering documents is the first step in the process. This includes any forms or
                    records that pertain to your conviction. Please gather all relevant court forms
                    and get a copy of your Criminal History Record Information (CHRI).{" "}
                </Typography>
                ...
                <Typography className={classes.volunteerTextStyle} variant="body1">
                    You might need a copy of your Criminal History Record Information (CHRI) to
                    vacate your record. There are two options:
                </Typography>
            ...
            >
                ...
                <Typography className={classes.volunteerTextStyle}>
                    Once you have your records and forms gathered, use our eligibilty calculator to
                    determine whether you are eligible to vacate your misdemeanor conviction. It is
                    expected to take 10-30 minutes.
                </Typography>
                <Typography className={classes.volunteerTextStyle}>
            ...
            >
                ...
                <Typography className={classes.volunteerTextStyle}>
                    ...
                    ). Please note that the request to vacate is up to the discretion of the judge
                    and may be denied for a variety of reasons.
                </Typography>
                <Typography className={classes.volunteerTextStyle}>
            ...
            >
                ...
                <Typography className={classes.volunteerTextStyle}>
                    Last but not least, schedule a hearing with a judge! Below are resources for
                    financial & legal aid.
                </Typography>
                <Typography className={classes.headingStyle} variant="h3">
                    Legal aid
                ...
                <Typography variant="body1">
                    Many pro bono services are only available after being referred by CLEAR, a
