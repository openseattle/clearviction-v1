...
const friendlyIndustries = [
    {
        ...
        details: "Virtual jobs usually do not need background checks, and a strong portfolio should suffice.",
    },
    {
    ...
    },
    {
        ...
        details: "The oil and gas industry offers endless opportunities for job seekers at any level.",
    },
    {
    ...
    return (
        <>
            <Container maxWidth="lg">
                <Grid container alignItems="flex-start">
                    ...
                    <Typography className={classes.contentText} variant="body1">
                        Simply having a conviction does not prevent you from having a job, however, it can be more
                        difficult depending on the type of job and the employer. It is important to not lose hope while
                        ...
                        <Grid item xs={12} sm={6}>
                            <Box className={classes.spacer}>
                                ...
                                <Typography className={classes.regularText}>
                                    of ex-prisoners remain out of work a year after prison release, and 60 percent are
                                    rearrested within three years
                                </Typography>
                                <Typography className={classes.regularText}>
                                    Those that can find steady work are less likely to return to prison
                                </Typography>

                                <Typography className={classes.citeText}>
                                    {" "}
                                    (Bureau of Justice Statistics 2002; Petersilia 2003; Travis 2005).
                                </Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <Box className={classes.spacer}>
                                ...
                                <Typography className={classes.regularText}>
                                    ...
                                    percent (28 vs. 15 percent).
                                </Typography>
                                <Typography className={classes.regularText}>
                                    Furthermore, the negative effect of a criminal conviction is substantially larger
            ...
            <Container className={classes.sectionSpaceStyle} maxWidth="md">
                <AccordionBuilder sectionHeading={"Conviction-friendly industries"} faqs={friendlyIndustries} />
            </Container>
            <Grid container>
                <Grid className={classes.lightBlueSectionBackground} item xs={12} sm={12} md={6}>
                    <Box className={classes.containerStyles}>
                        ...
                        <BulletedListMui>
                            <Box style={{ padding: "10px", }}>
                                ...
                                <li className={classes.contentText}>
                                    Adverse Treatment (disparate treatment or intentional discrimination)
                                </li>
                            </Box>
                        </BulletedListMui>
                        ...
                        <Typography className={classes.contentText} variant="body1">
                            ...
                            Commission enforces the most critical law with regards to the protection of felons, as
                            stated in Title VII of the Civil Rights Act of 1964.{" "}
                        </Typography>
                    </Box>
                </Grid>
                <Grid className={classes.darkBlueSectionBackground} item xs={12} sm={12} md={6}>
                    <Box className={classes.containerStylesAlt}>
                        <Typography variant="body1" align="center">
                            To find out whether your offense will or may disqualify you from a certain type of job, you
                            can check the{" "}
                            ...
                            <br />
                            <br />
                            To use the map, click on Washington State, and do a search for the category “Employment.”
                        </Typography>
                    </Box>
                </Grid>
            </Grid>
