          ...
          <Grid container className={classes.gridStyle} >
            <Grid item sm={12} md={6} className={classes.gridItemStyle}>
              ...
              >
                ...
                process easier and more staightforward,
                starting with an eligibility calculator.
              </Typography>
            </Grid>
      ...
      <Box>
        <Container maxWidth="md" className={classes.regularContainer} id="our-story">
          ...
          <Typography variant="h3" className={classes.subheadingStyle} >
            Those with a criminal record face significant 
            barriers to daily life after completing their 
            prison terms
          </Typography>
          ...
          <Box className={classes.boxShadow}>
            <Typography variant="subtitle1" className={classes.contentTextStyle}>
              ...
              makes it easier to people with past 
              criminal records to have their convictions vacated. Even then, the process of 
            ...
            <Grid container className={classes.gridStyle + " " + classes.centerText}>
              ...
              <Grid item md={4} className={classes.gridItemStyle}>
                ...
                <Typography variant="subtitle1">
                  While hiring an attorney can help 
              ...
              <Grid item md={4} className={classes.gridItemStyle}>
                ...
                <Typography variant="subtitle1">
                  Volunteer services are available, but 
                  they are often inaccessible and don't 
                  cover all steps 
                </Typography>
              </Grid>
            </Grid>
          ...
          <Grid container className={classes.gridStyle} >
            ...
            <Grid item sm={12} md={6} className={classes.gridItemStyle} >
              ...
              >
                ...
                to help people determine if they are 
                eligible to vacate their conviction.
              </Typography>
            </Grid>
          </Grid>
        </Box>
