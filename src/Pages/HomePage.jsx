    ...
    <div class="container-fluid">
      ...
      <div class="row dark-bg" id="how-it-works">
        ...
        <div class="col-sm">
          ...
          <br/><Text variant={"h5"} text={"We break down the laws into understandable language."} fontFamily={"Lora"}></Text>
        </div>

        <div class="col-sm">
          <img className="icons" src={phone} alt={"Mobile Phone Icon"}/>
          <br/><Text variant={"h5"} text={"You answer a few simple yes/no questions."} fontFamily={"Lora"}></Text>
        </div>
        <div class="col-sm">
        <img className="icons" src={employment} alt={"Employment Icon"}/>
        <br/><Text variant={"h5"} text={"This helps determine your vacation eligibility."} fontFamily={"Lora"}></Text>
        </div>
      ...
      <div class="row" id="why-vacate">
        ...
        <Text variant={"h4"} text={"A conviction vacation seals the offense from your record, and will give you more chance to access:"}></Text>

        <div class="col-sm">
          <img className="icons" src={housing} alt={"Housing Icon"}/>
          <Text variant={"h6"} text={"Housing"} fontWeight={"600"}></Text>
          <Text variant={"h5"} text={"Make it easier to find and be approved for rent or purchasing a home."} fontFamily={"Lora"}></Text>
        </div>

        <div class="col-sm">
          <img className="icons" src={employment} alt={"Employment Icon"}/>
          <Text variant={"h6"} text={"Employment"} fontWeight={"600"}></Text>
          <Text variant={"h5"} text={"Reduce barriers to finding and obtaining employment."} fontFamily={"Lora"}></Text>
        </div>

        <div class="col-sm">
          <img className="icons" src={education} alt={"Education Icon"}/>
          <Text variant={"h6"} text={"Education"} fontWeight={"600"}></Text>
          <Text variant={"h5"} text={"Apply for scholarships, programs, degrees or certificates."} fontFamily={"Lora"}></Text>
        </div>

        <div class="col-sm">
          <img className="icons" src={travel} alt={"Travel Icon"}/>
          <Text variant={"h6"} text={"Government Assistance"} fontWeight={"600"}></Text>
          <Text variant={"h5"} text={"Receive government help."} fontFamily={"Lora"}></Text>              
        </div>
        <div class="row">
        <div class="col-lg">
      ...
      <div class="row dark-bg">
        <div class="col-lg">
          ...
          <br/><Text variant={"h5"} fontFamily={"Lora"} text={"The Conviction Vacation Project connects volunteers passionate about reducing barriers and making it easier for those with convictions in Washington State."}></Text>
          <br/>
          <br/><Text variant={"h5"} fontFamily={"Lora"} text={"We’re working together to create a tool to make navigating the conviction vacation process easier. Currently we are designing and building an eligibility calculator to help people determine if their conviction is eligible for vacation."}></Text>
        ...
        <div class="col-lg">
          <Stack direction="row" sx={{ display: 'flex', padding: 5 }}>
            <Grid container columns={2} spacing={6} justifyContent="space-between">
              <Grid item>
                <List>
                  <ListItem><a href="/" style={{ color: '#000000' }}>Home</a></ListItem>
                  <ListItem><a href="/" style={{ color: '#000000' }}>Volunteer</a></ListItem>
                  <ListItem><a href="/calculator" style={{ color: '#000000' }}>Calculator</a></ListItem>
                  <ListItem><a href="/" style={{ color: '#000000' }}>Resources</a></ListItem>
                  <ListItem><a href="/about" style={{ color: '#000000' }}>About</a></ListItem>
                  <ListItem><a href="/" style={{ color: '#000000' }}>Contact</a></ListItem>
                </List>
              </Grid>
