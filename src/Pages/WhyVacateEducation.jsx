  ...
  return (
      <>
        ...
        <TwoParagraphTextWithHeader 
          ...
          text={[`An occupational license is a credential that the government requires a worker to hold in certain occupations. 
                  Aspiring workers must meet state-specific educational, training, testing and other requirements to practice 
                  in a licensed profession. Occupational licenses are mandatory in the relevant jurisdiction.`, `Individuals 
        ...
        <EducationOccLicReq />
        <TextWithCTAButton 
          text={"If you’re not yet eligible to vacate or want to know more, make sure to check out our resorces with tips for student loans, finding post-incarceration education and more."}
