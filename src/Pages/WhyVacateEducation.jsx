      ...
      <Container maxWidth="lg">
        <Grid container alignItems="flex-start">
          ...
          <Typography className={classes.contentText} variant="body1">
            ...
            jail or prison, however, many college and universities will collect
            background information and have full discretion over the admistion
            deciding process. These are the main educational challenges faced by
